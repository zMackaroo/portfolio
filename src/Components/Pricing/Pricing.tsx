import './Pricing.scss';
import Price1 from '../../Assets/Images/price-1.svg';
import Price2 from '../../Assets/Images/price-2.svg';
import Price3 from '../../Assets/Images/price-3.svg';
  ...
  return (
    <section className="pricing container section">
      ...
      <div className="pricing__container grid">
        ...
        <div className="pricing__item">
          <img src={Price3} alt="Price" className="pricing__img" />
          <h3 className="pricing__plan">Ultimate</h3>
          <p className="pricing__title">
            A wise option for large companies and individuals
          </p>
          <p className="pricing__suport">24/7 support</p>
          <h3 className="price">
            <em>$</em> 9 <span>Month</span>
          </h3>
          <a href="" className="btn">
